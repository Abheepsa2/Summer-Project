...
<h1 class="text-monocase text-capitalize text-center text-dark">All The Doctor's Schedule List Of Cardiologist</h1>
...
<ul class="pager font-weight-bold text-monospace">
  <li class="previous "><a href="dentist.php">Previous Page</a></li>
