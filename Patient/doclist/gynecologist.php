...
<h1 class="text-monocase text-capitalize text-center text-dark">All The Doctor's Schedule List Of Gynocologist </h1>
...
<ul class="pager font-weight-bold text-monospace">
  <li class="previous "><a href="surgeon.php">Previous Page</a></li>
