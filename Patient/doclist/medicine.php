...
<h1 class="text-monocase text-capitalize text-center text-dark">All The Doctor's Schedule List Of Medicine</h1>
...
$query ="SELECT * 
    ...
    while($row = mysqli_fetch_array($run))
    {
     ...
     echo  "<h3><tr><th><a href='detail.php?s_id={$row['s_id']}'>{$row['f_name']} <br>{$row['l_name']}</a></h3>";
...
<ul class="pager font-weight-bold text-monospace">
  <li class="previous "><a href="../disease_prediction.php">Previous Page</a></li>
