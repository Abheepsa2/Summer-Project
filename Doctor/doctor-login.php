...
<div class="col-md-12  d-flex  justify-content-center align-items-center register-right" style="margin-top: -25px;left: 80px;">
                        <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist" style="width: 50%;">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="doctor-login.php" role="tab" aria-controls="profile" aria-selected="false">Doctor</a>
                            </li>
                            <li class="nav-item">
	...
	<div class="wrapper bg-white">
		...
		<div class="h1 text-center">DOCTOR LOGIN </div>
		<div class="h6 text-muted text-center pt-2">Enter your login details</div>
			...
			<div class="d-flex align-items-start">
				...
				<div class="text-center mb-5 text-black">Not registered yet
				   ...
				   <a class="login-link" href="doctor-register.php">Register here</a>
			</div>
     ...
     <div  class="container d-flex justify-content-center align-items-center min-vh-100">
       ...
       <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box" >
           <div class="featured-image mb-3">
            <img src="doclogin.jpg" class="img-fluid" style="width: 420px; height:420px;">
           </div>
          </div> 
       <div class="col-md-6 right-box">
          <div class="row align-items-center">
                ...
                <div class="row">
                    <p>Don't have account? <a href="doctor-register.php">Register</a></p>
                </div>
           </div>
          </div> 
